...
class ChartingState extends MusicBeatState
{
	...
	**/
	...
	function addSongUI():Void
	{
		...
		var characters:Array<String> = CoolUtil.coolTextFile(Paths.txt('characterList'));/*[Paths.getPreloadPath('characters/')];*/
		...
		tempMap.clear();
		var stageFile:Array<String> = CoolUtil.coolTextFile(Paths.txt('stageList'))/*[Paths.getPreloadPath('stages/')]*/;
