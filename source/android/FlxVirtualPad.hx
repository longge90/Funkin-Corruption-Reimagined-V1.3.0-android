	...
	public function new(?DPad:FlxDPadMode, ?Action:FlxActionMode, ?alphaAlt:Float = 0.75, ?antialiasingAlt:Bool = true) {
		...
		switch (Action){
			...
			case A_B_C_X_Y:		
				...
				actions.add(add(buttonA = createButton(FlxG.width - 44 * 3, FlxG.height - 45 * 3, 44 * 3, 45 * 3, "a")));	
			case A_B_C_X_Y_2:
				actions.add(add(buttonX = createButton(FlxG.width - 128 * 3, 45 * 3, 44 * 3, 45 * 3, "x")));
				actions.add(add(buttonY = createButton(FlxG.width - 86 * 3, 45 * 3, 44 * 3, 45 * 3, "y")));
				actions.add(add(buttonZ = createButton(FlxG.width - 44 * 3, 45 * 3, 44 * 3, 45 * 3, "z")));
				actions.add(add(buttonC = createButton(FlxG.width - 128 * 3, 85 * 3, 44 * 3, 45 * 3, "c")));
				actions.add(add(buttonB = createButton(FlxG.width - 86 * 3, 85 * 3, 44 * 3, 45 * 3, "b")));								
				actions.add(add(buttonA = createButton(FlxG.width - 44 * 3, 85 * 3, 44 * 3, 45 * 3, "a")));			
			case A_B_C_X_Y_Z:
