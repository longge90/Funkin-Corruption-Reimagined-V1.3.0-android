...
class PixelRGBPalette {
	public var shader(default, null):PixelRGBPaletteShader = new PixelRGBPaletteShader();
	public var r(default, set):FlxColor;
	public var g(default, set):FlxColor;
	public var b(default, set):FlxColor;
	public var mult(default, set):Float;
	public var pixel(default, set):Float = 1;
    ...
    public function set_pixel(value:Float)
	{
		//pixel = value;
	...
	public function new()
	{
		...
		b = 0xFF0000FF;
		mult = 1.0;
		if (!PlayState.isPixelStage) pixel = 0.0;
	}
}

// automatic handler for easy usability
class PixelRGBShaderReference
{
	public var r(default, set):FlxColor;
	public var g(default, set):FlxColor;
	public var b(default, set):FlxColor;
	...
	public var parent:PixelRGBPalette;
	private var _owner:FlxSprite;
	private var _original:PixelRGBPalette;
	public function new(owner:FlxSprite, ref:PixelRGBPalette)
	{
		parent = ref;
		_owner = owner;
		_original = ref;
	...
	public function set_pixel(value:Float)
	{
		if(allowNew && value != _original.pixel) cloneOriginal();
	    return (pixel = parent.pixel = value);
	}
...
class PixelRGBPaletteShader extends FlxShader {
	@:glFragmentHeader('
		#pragma header
